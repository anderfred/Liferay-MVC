...
/**
 * Provides the local service interface for vacancyArea. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see vacancyAreaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface vacancyAreaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link vacancyAreaLocalServiceUtil} to access the vacancy area local service. Add custom service methods to <code>com.anderfred.service.impl.vacancyAreaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
