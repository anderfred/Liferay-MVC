...
/**
 * Provides the local service interface for vacancySpec. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see vacancySpecLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface vacancySpecLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link vacancySpecLocalServiceUtil} to access the vacancy spec local service. Add custom service methods to <code>com.anderfred.service.impl.vacancySpecLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public vacancySpec addvacancySpec(vacancySpec vacancySpec);
	...
	public vacancySpec createvacancySpec(int id);
	...
	public vacancySpec deletevacancySpec(int id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public vacancySpec deletevacancySpec(vacancySpec vacancySpec);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public vacancySpec fetchvacancySpec(int id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public vacancySpec getvacancySpec(int id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<vacancySpec> getvacancySpecs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public vacancySpec updatevacancySpec(vacancySpec vacancySpec);
